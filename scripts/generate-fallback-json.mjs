// One-off script: converts sample_data/Knowledge_base_updated.xlsx into checked-in JSON
...
// sample_data/Knowledge_base_updated.xlsx changes. Reads a "Master" sheet (singular) -
...
async function main() {
  ...
  const kbTrackerWs = wb.getWorksheet("KB Tracker");
  const kbTracker = kbTrackerWs ? sheetToRecords(kbTrackerWs) : [];
